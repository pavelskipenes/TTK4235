...
# 6 "source/modes.c" 2
# 1 "source/headers/modes.h" 1
# 10 "source/headers/modes.h"
...
void emergency();
# 7 "source/modes.c" 2
# 1 "source/headers/elevator.h" 1
# 11 "source/headers/elevator.h"
...
# 12 "source/headers/elevator.h" 2
...
# 13 "source/headers/elevator.h" 2
# 1 "source/headers/hardware.h" 1
# 17 "source/headers/hardware.h"
...
# 71 "source/headers/hardware.h"
int hardware_read_floor_sensor(int floor);
# 83 "source/headers/hardware.h"
...
# 21 "source/headers/elevator.h" 3 4
_Bool 
# 21 "source/headers/elevator.h"
    upOrders[4];
...
# 26 "source/headers/elevator.h" 3 4
_Bool 
# 26 "source/headers/elevator.h"
    downOrders[4];
...
# 31 "source/headers/elevator.h" 3 4
_Bool 
# 31 "source/headers/elevator.h"
    insideOrders[4];
...
# 37 "source/headers/elevator.h" 3 4
_Bool 
# 37 "source/headers/elevator.h"
    emergencyState;
...
# 42 "source/headers/elevator.h" 3 4
_Bool 
# 42 "source/headers/elevator.h"
    hasOrders;
...
# 47 "source/headers/elevator.h" 3 4
_Bool 
# 47 "source/headers/elevator.h"
    obstruction;
...
# 74 "source/headers/elevator.h" 3 4
   _Bool 
# 74 "source/headers/elevator.h"
        above;
} Position;
Position position;
...
Direction direction;
# 99 "source/headers/elevator.h"
int targetFloor;
# 8 "source/modes.c" 2
# 1 "source/headers/hardware.h" 1
# 9 "source/modes.c" 2
# 1 "source/headers/modeReaders.h" 1
       

void goToFloorReader();
void emergencyModeReader();
# 10 "source/modes.c" 2
# 1 "source/headers/interface.h" 1
       
# 1 "source/headers/elevator.h" 1
# 3 "source/headers/interface.h" 2


# 4 "source/headers/interface.h" 3 4
_Bool 
# 4 "source/headers/interface.h"
    activeOrderThisFloor();

# 5 "source/headers/interface.h" 3 4
_Bool 
# 5 "source/headers/interface.h"
    atSomeFloor();

# 6 "source/headers/interface.h" 3 4
_Bool 
# 6 "source/headers/interface.h"
    checkEmergency();

# 7 "source/headers/interface.h" 3 4
_Bool 
# 7 "source/headers/interface.h"
    isValidFloor(int floor);

# 8 "source/headers/interface.h" 3 4
_Bool 
# 8 "source/headers/interface.h"
    onFloor(int floor);

# 9 "source/headers/interface.h" 3 4
_Bool 
# 9 "source/headers/interface.h"
    orderAt(int floor);

# 10 "source/headers/interface.h" 3 4
_Bool 
# 10 "source/headers/interface.h"
    readObstruction();

# 11 "source/headers/interface.h" 3 4
_Bool 
# 11 "source/headers/interface.h"
    readStop();
...
# 11 "source/modes.c" 2
# 1 "source/headers/modeSelector.h" 1
...
# 24 "source/modes.c"
  ...
  signal(
# 34 "source/modes.c" 3 4
        2
# 34 "source/modes.c"
              , sigint_handler);
  signal(
# 35 "source/modes.c" 3 4
        15
# 35 "source/modes.c"
               , sigint_handler);
  signal(
# 36 "source/modes.c" 3 4
        11
# 36 "source/modes.c"
               , sigint_handler);
